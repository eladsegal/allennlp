...
# Hack in old logging code for now, new function is below with _new postfix
def prepare_global_logging(
	    serialization_dir: str, file_friendly_logging: bool, rank, world_size
) -> logging.FileHandler:
    """
...
def prepare_global_logging_new(
